...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/linkman_edit.js"></script>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td colspan="3"><input id="custId" type="text" name="custId" style="WIDTH: 180px" value="<%-- ${linkman.cstCustomers.custId} --%>" />
								<select id="custSelect"  name="custNameS" ><!-- <option id="custOption">请选择</option>  --></select>
								</td>
